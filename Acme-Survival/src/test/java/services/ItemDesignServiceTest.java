...
// /* Class<?> expected */null
// }, {
// // This test checks that authenticated designers can create a resource with minium values
// ItemType.RESOURCE, "Designer1", "Test name", "Nombre prueba", "Test description", "Descripción prueba", /* imageUrl */"https://www.myimage.com", /* finalMode */false,
// /* strength */null,/* luck */null, /* capacity */null, /* water */0.,
// /* food */0., /* metal */0., /* wood */0.,
// /* Class<?> expected */null
// }, {
// // This test checks that authenticated designers can create a resource with water less than minium values
// ItemType.RESOURCE, "Designer1", "Test name", "Nombre prueba", "Test description", "Descripción prueba", /* imageUrl */"https://www.myimage.com", /* finalMode */false,
// /* strength */null,/* luck */null, /* capacity */null, /* water */-1.,
// /* food */0., /* metal */0., /* wood */0.,
// /* Class<?> expected */null
// }, {
// // This test checks that authenticated designers can create a resource with food less than minium values
// ItemType.RESOURCE, "Designer1", "Test name", "Nombre prueba", "Test description", "Descripción prueba", /* imageUrl */"https://www.myimage.com", /* finalMode */false,
// /* strength */null,/* luck */null, /* capacity */null, /* water */0.,
// /* food */-1., /* metal */0., /* wood */0.,
// /* Class<?> expected */null
// }, {
// // This test checks that authenticated designers can create a resource with metal less minium values
// ItemType.RESOURCE, "Designer1", "Test name", "Nombre prueba", "Test description", "Descripción prueba", /* imageUrl */"https://www.myimage.com", /* finalMode */false,
// /* strength */null,/* luck */null, /* capacity */null, /* water */0.,
...
// this.templateCreateRoomDesigns((ItemType) testingData[i][0], (String) testingData[i][1], (String) testingData[i][2], (String) testingData[i][3], (String) testingData[i][4], (String) testingData[i][5], (Integer) testingData[i][6],
...
// // Ancillary methods ---------------------------------------------------------------------------------------
//
// protected void templateCreateRoomDesigns(final ItemType roomType, final String username, final String nameEn, final String nameEs, final String descriptionEn, final String descriptionEs, final Integer maxResistance, final Double costWood,
...
//
// if (roomType.equals(ItemType.TOOL)) {
...
// } else if (roomType.equals(ItemType.WAREHOUSE)) {
//
...
//
// } else if (roomType.equals(ItemType.RESOURCE)) {
...
//
// } else if (roomType.equals(ItemType.RESOURCE_ROOM)) {
