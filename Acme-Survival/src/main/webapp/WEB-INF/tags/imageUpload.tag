...
<div>
	...
	<div class="row">
		<div class="input-field col s2">
			<a href="javascript:void(0);" onclick="useImageUpload();"><spring:message
					code="master.page.imageHandling.upload" /></a>
		</div>
		<div class="input-field col s2">
			<a href="javascript:void(0);" onclick="useImageUrl();"><spring:message
					code="master.page.imageHandling.url" /></a>
		</div>
	</div>
	<div class="row">
		<div class="input-field col s3">
			...
			<p id="imageMax">
				<spring:message code="master.page.imageHandling.maximum" />
			</p>
		...
		<div class="input-field col s6">
			<img id="preview"
				...
				height="200"
				alt="<spring:message code="master.page.imageHandling.imagePreview"/>"
				onload="imageReload();">
		</div>
	</div>
</div>