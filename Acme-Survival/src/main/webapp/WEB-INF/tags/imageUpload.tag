...
<div>
	<div class="row">
		<div class="input-field col s2">
			<a href="javascript:void(0);" onclick="useImageUpload();"><spring:message code="master.page.imageHandling.upload"/></a>
		</div>
		<div class="input-field col s2">
			<a href="javascript:void(0);" onclick="useImageUrl();" ><spring:message code="master.page.imageHandling.url"/></a>
		</div>
	</div>
	<div class="row">
